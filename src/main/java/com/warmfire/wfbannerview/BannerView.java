package com.warmfire.wfbannerview;
...
/**
 * Created by warmfire on 2017-06-01.
 */
...
public class BannerView<Item> extends FrameLayout {
    ...
    private boolean hasMove = false; // 检测是否滑动以点击事件
    ...
    private final Runnable mRunnable = new Runnable() {
        @Override
        public void run() {
            Log.e("warmfire", "running=" + mIsRunning + ",pos=" + mCurrentPosition);
            if (mIsRunning) {
    ...
    private int mItemHeight = LayoutParams.MATCH_PARENT;
    ...
    private BannerView.ViewFactory mViewFactory;
    private BannerView.TitleAdapter mTitleAdapter = new BannerView.TitleAdapter() {
        @Override
    ...
    public void setContext(Context context, Class<?> cls){
        this.context = context;
        this.cls = cls;
    }
    ...
    void update() {
        ...
        Log.e("warmfire", "update:running=" + mIsRunning + ",visible=" + mIsVisible + ",started=" + mIsStarted + ",resumed=" + mIsResumed);
        Log.e("warmfire", "update:auto=" + mIsAuto + ",loop=" + isLoop() + ",size=" + mDataList.size() + ",current=" + mCurrentPosition);
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP:
                if(!hasMove){
                    if(clickType == 0){
                        Toast.makeText(context, "mCurrentPosition --> " + (mCurrentPosition+1), Toast.LENGTH_SHORT).show();
                    } else if(clickType == 1){
    ...
    private ViewPager.OnPageChangeListener mInternalPageListener = new ViewPager.OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            ...
            Log.e("warmfire", "onPageSelected, pos=" + mCurrentPosition);
    ...
    private PagerAdapter mInternalPagerAdapter = new PagerAdapter() {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            inflate = (ImageView) inflate;
            ((ImageView) inflate).setScaleType(scaleType);
